            ...
            <Encabezado />
                ...
                <main>
                    <div className="contenedor">
                        <h1> plomeria</h1>
                        <img src={require("../images/plomeria.jpg")} class="plomeria"></img>
                        ...
                        <h1>acabado</h1>
                        <img src={require("../images/acabados.jpg")} class="acabado"></img>
                        ...
                        <h1>electrico</h1>
                        <img src={require("../images/electrico.jpg")} class="electrico"></img>
                        ...
                        <h1>manual</h1>
                        <img src={require("../images/manual.jpg")} class="manual"></img>
                        ...
                        <h1>neumatica</h1>
                        <img src={require("../images/neumatica.jpg")} class="neumatica"></img>
                        ...
                        <h1> maquinaria </h1>
                        <img src={require("../images/maquinaria.jpg")} class="maquinaria"></img>
